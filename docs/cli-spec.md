...
| `--web <choice>` | `next` \| `sveltekit` \| `tanstack-start` \| `astro` \| `react-router` \| `none` | prompt | Web app in `apps/web` |
...
| Flag | Values | Default | Notes |
| --- | --- | --- | --- |
| `<scaffold>` | `next` \| `sveltekit` \| `tanstack-start` \| `astro` \| `react-router` \| `expo` \| `tauri` \| `electron` \| `elysia` \| `hono` \| `convex` | required | Positional: the scaffold to grow |
